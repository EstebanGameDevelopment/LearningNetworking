...
namespace YourVRExperience.Network
{
    ...
    public class MirrorController : NetworkManager
    {
        ...
        public int CmdNetworkObject(string _prefab, Vector3 _position, int _owner, params object[] _parameters)
        {
            string initialData = "";
            string initialTypes = "";
            MirrorController.Serialize(_parameters, ref initialData, ref initialTypes);
            m_mirrorConnection.CmdNetworkObject(_prefab, m_instanceCounter, _position, _owner, initialData, initialTypes);
            m_instanceCounter++;
